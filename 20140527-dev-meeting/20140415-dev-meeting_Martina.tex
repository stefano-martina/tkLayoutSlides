...
\begin{frame}
  \begin{center}
    \includegraphics[width=\textwidth]{servizi.pdf}
  \end{center}

  \begin{itemize}
  \item \alert{Sezioni} sopra layers
  \item \alert{Stazioni} a destra del layer
  \item Sezioni per unire stazioni a bordo
  \item Sezioni per il \alert{routing}
  \end{itemize}
\end{frame}

\begin{frame}
  \begin{center}
    \includegraphics[width=\textwidth]{stazioni.pdf}
  \end{center}
  
  \begin{itemize}
  \item Problemi/Sviluppi:
    \begin{itemize}
    \item Stazioni troppo \alert{piccole}
    \item \alert{Integrazione} difficile/macchinosa con codice esistente
    \item Cambiare formato \alert{file} configurazione
    \end{itemize}
  \end{itemize}
\end{frame}
